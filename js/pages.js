...
/* Uebungsdatenbank und Bildpfade stehen seit dem Herausloesen in
   js/exercises.js. Diese Datei enthaelt nur noch Renderfunktionen
   fuer die Desktop-Ansicht und wird auf dem Handy nicht mehr beim
   Start geladen, sondern erst bei Bedarf (ensurePages() in
   js/f7app.js). Neue Uebungen gehoeren nach js/exercises.js. */
...
const saeulenData = [
  ...
  { name:'KRAFT, POWER & SCHNELLIGKEIT', category:'Fundament', color:'var(--red)',
    ...
    desc:`<strong style="font-size:15px;">DIE PHYSIK HINTER DEM SCHLAG</strong><br>
Ein Schlag wird in einem Wimpernschlag geliefert – oft unter <strong>200 Millisekunden</strong>. Das erfordert, in kürzester Zeit enorm viel Kraft zu erzeugen. Unabhängig vom Schlagtyp wird die Kraft im Unterkörper generiert und über Hüfte, Rumpf und Schlagarm zur Faust und ins Ziel übertragen. Die Muskeln werden sequentiell von unten nach oben aktiviert und arbeiten zusammen, um zuerst Geschwindigkeit und dann Steifheit beim Aufprall zu erzeugen.<br><br>

Bei geraden Schlägen (Jab und Cross) treiben sich Boxer nach vorne zum Ziel. Bei Haken werden Kräfte auch seitlich erzeugt. Boxer erzeugen dabei eine "Blockbewegung" mit dem Bein gegenüber dem Schlagarm – das erhöht die ${tt('Hüftrotationsgeschwindigkeit','Die Blockbewegung wandelt linearen Impuls (gerade Kraft aus den Beinen) in Drehimpuls um, der dann durch die kinetische Kette übertragen wird.')} und wandelt linearen Impuls in Drehimpuls um.<br><br>

<strong>Faust-Geschwindigkeiten:</strong> Cross ca. <strong>8.5 m/s (30 km/h)</strong>, Haken bis <strong>12 m/s (43 km/h)</strong>. Bei Kombinationen werden Schläge noch schneller – Jab und Cross in nur <strong>0.2 Sekunden</strong>, Haken in 0.4 Sekunden.<br><br>
...
• <strong>Horizontal Press</strong> – Brustmuskulatur für Handgeschwindigkeit und "Steifheit" beim Aufprall<br>
• <strong>Vertical Press</strong> – Funktionelle Schulterkraft gegen Imbalancen durch die Guard-Position<br>
...
• <strong>Phase 1 – Landen/Springen:</strong> Altitude Landings, Box Jumps – Landungsmechanik und Kraftabsorption lernen<br>
• <strong>Phase 2 – Springen:</strong> Countermovement Jumps, Altitude Landing to Jump – Kraft übertragen<br>
• <strong>Phase 3 – Beladen:</strong> DB CMJ, MB Box Jumps – maximale Kraftentwicklung unter Last<br><br>

<strong>Kurzer Dehnungs-Verkürzungs-Zyklus (Reaktivkraft):</strong><br>
Verbessert die Fuß-Reaktivität für schnelle Beinarbeit. Entwicklung: Low & Fast Pogos → Band Assisted Pogos → Max Effort Pogos. Die Achillessehne wird zum Federmechanismus trainiert – weniger Muskelarbeit = weniger Energiekosten bei der Beinarbeit.<br><br>

<strong>Laterale Kraft:</strong> Ice Skaters → MB Ice Skaters → Repeated MB Ice Skaters für seitliche Explosivkraft beim Winkelschneiden und Ausweichen.<br><br>

<strong style="font-size:15px;">SCHLAGSPEZIFISCHE ÜBUNGEN</strong><br>
Traditionelles Krafttraining entwickelt die RFD – aber Boxer müssen diese Kraft auch in schlagspezifische Aktionen übertragen:<br>
• <strong>Medizinball-Schlagwurf:</strong> Schnelle Rotation und Hüftextension, Start in Kampfstellung<br>
• <strong>Landmine Punch / Punch Throw:</strong> Verschiedene Lasten für verschiedene Phasen (Kraft → Kraft-Schnelligkeit → Geschwindigkeit)<br>
...
<strong>Woche 10 — Taper:</strong> Volumen -50%, Intensität beibehalten. Fitness erhalten, Ermüdung abbauen.`,
    tags:[{text:'2×/Woche',cls:'tag-red'},{text:'50 Min.',cls:'tag-blue'},{text:'3 Phasen + Taper',cls:'tag-gold'}]},
  ...
  { name:'METABOLISCHE KAPAZITÄT', category:'Aerob', color:'var(--red)',
    ...
    desc:`<strong style="font-size:15px;">DIE PHYSISCHEN ANFORDERUNGEN DES BOXENS</strong><br>
Ein Profikampf kann bis zu <strong>47 Minuten</strong> dauern, mit 36 Minuten aktiver Zeit. Der Rekord für die meisten Schläge liegt bei <strong>1848 in 10 Runden</strong> – ein Schlag pro Sekunde über 30 Minuten. Auch auf niedrigerem Niveau sind 150 Schläge pro Runde keine Seltenheit. Blutlaktatwerte erreichen bis zu <strong>16 mmol/L</strong> im Amateurboxen.<br><br>

Doch es ist nicht nur das Schlagvolumen – <strong>77% der Kämpfe</strong> in MMA werden durch 8-12 Sekunden vorherige Hochintensitäts-Aktivität gewonnen. Die Fähigkeit, wiederholte hochintensive Aktionen auszuführen, ist oft der entscheidende Faktor.<br><br>

<strong style="font-size:15px;">DEIN ENERGIETANK</strong><br>
Stell dir deine aerobe Kapazität als ${tt('Energietank','Je größer dein aerobes System, desto mehr Energie kannst du produzieren. Ein Boxer mit VO₂max von 4.5 L/min kann 20 Kcal/min produzieren vs. 16 Kcal/min bei 3.5 L/min.')} vor. Kämpfer A hat einen größeren Tank als Kämpfer B. Das Ziel des Conditioning ist, diesen Tank so groß wie möglich zu machen. Damit kannst du deine ${tt('Kampf-Intensität','Die Intensität, bei der du kämpfen kannst ohne zu ermüden. Wird durch die aerobe Kapazität bestimmt.')} höher setzen als die deines Gegners – und ihn zwingen, in deinem Tempo zu kämpfen.<br><br>

<strong>Die Wissenschaft dahinter (Fick-Gleichung):</strong><br>
VO₂ = ${tt('Herzleistung','Wie viel sauerstoffreiches Blut dein Herz zu den Muskeln pumpen kann.')} × ${tt('a-vO₂ Differenz','Wie effektiv deine Muskeln Sauerstoff aus dem Blut extrahieren und zur Energieproduktion nutzen.')}<br>
Um die aerobe Kapazität zu verbessern: (1) Herzpumpleistung steigern, (2) Gefäßnetzwerk verbessern, (3) oxidative Enzyme in der Muskelzelle optimieren. Genau das erreichen wir mit <strong>hochintensivem Conditioning</strong>.<br><br>
...
<strong>SÄULE 2 — MUSCLE BUFFERING (Wo. 1-3)</strong><br>
Kurzintervall-Training bei hoher Geschwindigkeit entwickelt die Fähigkeit der Muskeln, ${tt('Azidose','Übersäuerung – wenn Wasserstoffionen sich ansammeln und die Kraftproduktion beeinträchtigen. "Das Brennen" in den Armen.')} zu puffern. <strong>1-2 Min. Intervalle</strong> bei 15-18 km/h, 3% Steigung, RPE 7-8, Ziel-Laktat 10-12 mmol/L. Work:Rest Ratio 1:2.<br><br>
...
<strong>Trainingsload-Management:</strong> 3:1 Loading-Pattern – 3 Wochen aufbauen, 1 Woche Deload. Trainingslast nie mehr als 10% pro Woche steigern. Spikes vermeiden → Verletzungs- und Krankheitsrisiko.<br><br>

<strong style="font-size:15px;">HERZFREQUENZ-MONITORING</strong><br>
Nutze einen Bluetooth-Herzfrequenzgurt (Polar H10, Wahoo TickR) und berechne deine rote Zone:<br>
• Max HF = 220 - Alter (oder über einen Rampen-Test ermitteln)<br>
• Rote Zone = 90% × Max HF<br>
• Ziel pro HIIT-Session: 6-12 Min. in der roten Zone`,
    tags:[{text:'3×/Woche',cls:'tag-blue'},{text:'3 Phasen · 10 Wochen',cls:'tag-green'}]},
